...
def generate(img_idx, cur_post_dir, script, prv_result_dict = None):
    # print(img_idx)
    concat_img = get_concat_img_obj_by_idx(img_idx, os.path.join(cur_post_dir,"screen_captures"))
    # display(concat_img)
    concat_img.save(os.path.join(cur_post_dir,"temp.png"))
    img_obj = encode_image(os.path.join(cur_post_dir,"temp.png"))
    ...
    # print(result_dict['사용한 스크립트'], "\n")
    # print(result_dict['현재까지 사용한 전체 스크립트'], "\n")
    return result_dict
